...
KEY1 = "kD87Ef4y043nhee-W_Hytc0d3Bkiw4Gw21m-7AHpZkc="

with open('key_2.txt','rb') as key:
    key2 = key.read()
...
# vignere ZHERO key
KEY3 = "XeQVPB98P3fve4lJvfk345uARbNDE4F17NFZJBHC1dY="

ct = b'gAAAAABe5zDHy1Vk74P8AspzQ4bqK9dzfI52djZeMbsXRk8G5ng1BtYmDj7v6SCbx7cvnUFu2fDh6XTVtQPQqlJcVVCxGoA0P4L_gtSIGHQPLZysxuoN1E7kP_5lZFbZLo6b6G-YqFxs'

k1 = base64.urlsafe_b64decode(KEY1)
k2 = base64.urlsafe_b64decode(KEY2)
k3 = base64.urlsafe_b64decode(KEY3)
